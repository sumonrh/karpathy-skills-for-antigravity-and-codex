...
Full Mode (Default):
- Sequence: Code blocks first → Maximum 3 short trailing lines.
- Those trailing lines highlight only what was deliberately skipped and any edge condition requiring an upgrade path.
